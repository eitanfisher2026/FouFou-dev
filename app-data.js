...
form: {
  ...
  selectAreaFirst: 'Please select an area before generating the route',
  details: 'Details',
...
trail: {
  ...
  addGoogleToFavorites: 'Add "{name}" to favorites?\nThis place will be preferred over Google results and appear first in future routes.',
