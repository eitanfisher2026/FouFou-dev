...
// Keys must match the actual Firebase customInterests IDs exactly
const _tw = 'https://twemoji.maxcdn.com/v/latest/72x72/';
window.BKK.interestIconPaths = {
  // Auto-generated Firebase push IDs (original interests)
  ...
  // custom_* IDs (later-added interests)
  ...
  // Clean i_xxx IDs (newer interests created with explicit keys)
